...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_0,      view,           {.ui = ~0 } }, /* show all windows on all tags */
	{ MODKEY|ShiftMask,             XK_0,      tag,            {.ui = ~0 } }, /* not useful */
	{ MODKEY,                       XK_comma,  focusmon,       {.i = -1 } }, /* go to other monitor */
	{ MODKEY,                       XK_period, focusmon,       {.i = +1 } }, /* go to other monitor */
	{ MODKEY|ShiftMask,             XK_comma,  tagmon,         {.i = -1 } }, /* not useful */
	{ MODKEY|ShiftMask,             XK_period, tagmon,         {.i = +1 } }, /* not useful */
	TAGKEYS(                        XK_1,                      0) /* go to tag 0 */
	TAGKEYS(                        XK_2,                      1) /* go to tag 1 */
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
	TAGKEYS(                        XK_5,                      4)
	TAGKEYS(                        XK_6,                      5)
